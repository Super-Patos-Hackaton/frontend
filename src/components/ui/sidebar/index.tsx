...
export const Sidebar = ({ navLinks }: { navLinks: React.ReactNode }) => {
  ...
  return (
    <aside
      ...
      className={cn(
        'sticky left-0 top-0 z-20 h-screen -translate-x-full transition-[width] duration-300 ease-in-out lg:translate-x-0',
        !sidebar?.isOpen ? 'w-[76px]' : 'w-80'
      )}
    >
      <div className='relative flex h-full flex-col items-center overflow-y-auto overflow-x-hidden bg-secondary px-3 py-4 shadow-md shadow-foreground/10'>
